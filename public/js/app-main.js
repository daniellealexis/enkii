...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(52), __webpack_require__(89)(module)))
...
var _decorators = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__eridu__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__flashMessages_flashManager__ = __webpack_require__(91);
...
document.addEventListener('DOMContentLoaded', function () {
    var Eridu = Object(__WEBPACK_IMPORTED_MODULE_0__eridu__["a" /* initializeOnWindow */])();

    initializeFlashManager(Eridu);
});

function initializeFlashManager(Eridu) {
    var flashManager = Object(__WEBPACK_IMPORTED_MODULE_1__flashMessages_flashManager__["a" /* createInstance */])({ Eridu: Eridu });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return initializeOnWindow; });
...
var Eridu = function () {
    ...
    function get() {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["get"])(store, dataKey, defaultValue);
    };

    function has() {
        var dataKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

        return Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["has"])(store, dataKey);
    };

    function set(key, value) {
        if (typeof key === 'string' || Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["isArray"])(key)) {
            Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["set"])(store, key, value);
        } else if (typeof key === 'undefined') {
            // If undefined, don't set anything
        } else if (Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["isPlainObject"])(key)) {
            // If object, extend on store
            Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["extend"])(store, key);
        } else {
...
"use strict";
/* unused harmony export getInstance */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return createInstance; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__flashBannerComponent__ = __webpack_require__(92);


function flashManager(opts) {
    var Eridu = opts.Eridu || window.Eridu;
    var activeBanner;

    function _createFlashBanner() {
        ...
        newBanner = new __WEBPACK_IMPORTED_MODULE_0__flashBannerComponent__["a" /* default */](opts);
...
var flashBanner = function () {
    function flashBanner(opts) {
        ...
        this.duration = typeof opts.duration === 'number' ? opts.duration : null;

        this.removeBannerFromManager = typeof opts.removeBannerFromManager === 'function' ? opts.removeBannerFromManager : function () {};
    ...
    _createClass(flashBanner, [{
        ...
        value: function _getTemplateData() {
            return {
                type: this.type,
        ...
        key: '_createBannerElement',
        value: function _createBannerElement() {
...
/* harmony default export */ __webpack_exports__["a"] = (flashBanner);
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"flash-banner flash-banner__"
    + alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"type","hash":{},"data":data}) : helper)))
    + "\">\r\n    <h4 class=\"flash-banner--text\">"
    + alias4(((helper = (helper = helpers.message || (depth0 != null ? depth0.message : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"message","hash":{},"data":data}) : helper)))
    + "</h4>\r\n    <i class=\"flash-banner--close-icon\">&#x00425;</i>\r\n</div>\r\n";
},"useData":true});
...
var _handlebarsNoConflict = __webpack_require__(109);
...
var _decoratorsInline = __webpack_require__(105);
